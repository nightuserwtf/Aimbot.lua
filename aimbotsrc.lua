...
if not getgenv().gl0ry or getgenv().gl0ry.WallHack then return end
...
local Environment = getgenv().gl0ry.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().gl0ry.WallHack.Functions = nil
	getgenv().gl0ry.WallHack = nil
