...
if not getgenv().gl0ry or getgenv().gl0ry.Aimbot then return end
...
local Environment = getgenv().gl0ry.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().gl0ry.Aimbot.Functions = nil
	getgenv().gl0ry.Aimbot = nil
